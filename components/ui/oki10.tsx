...
const UNIFORMS = {
  colors: [
    [0.145098, 0.388235, 0.921569], // #2563EB (Medical Blue)
    [0.023529, 0.713725, 0.831372], // #06B6D4 (Cyan)
    [0.117647, 0.250980, 0.686275], // #1E40AF (Dark Medical Blue)
    [0.937255, 0.964706, 1.000000], // #EFF6FF (Light Blue)
  ...
  brightness: 0.500,
  saturation: 0.850,
  hue: 0.000, // 0.0 preserves exact brand color codes without rotation
  vignette: 0.400,
  blur: 0.0400,
  grain: 0.000,
  seed: 1.0,
