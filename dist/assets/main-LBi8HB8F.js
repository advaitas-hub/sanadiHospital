(function(){const B=document.createElement("link").relList;if(B&&B.supports&&B.supports("modulepreload"))return;for(const E of document.querySelectorAll('link[rel="modulepreload"]'))_(E);new MutationObserver(E=>{for(const I of E)if(I.type==="childList")for(const F of I.addedNodes)F.tagName==="LINK"&&F.rel==="modulepreload"&&_(F)}).observe(document,{childList:!0,subtree:!0});function H(E){const I={};return E.integrity&&(I.integrity=E.integrity),E.referrerPolicy&&(I.referrerPolicy=E.referrerPolicy),E.crossOrigin==="use-credentials"?I.credentials="include":E.crossOrigin==="anonymous"?I.credentials="omit":I.credentials="same-origin",I}function _(E){if(E.ep)return;E.ep=!0;const I=H(E);fetch(E.href,I)}})();document.addEventListener("DOMContentLoaded",()=>{const $=document.getElementById("siteIntroPreloader");$?(document.body.style.overflow="hidden",setTimeout(()=>{$.classList.add("fade-out"),document.body.classList.add("intro-complete"),document.body.style.overflow="",setTimeout(()=>{$.parentNode&&$.parentNode.removeChild($)},850)},800)):document.body.classList.add("intro-complete"),window.lucide&&window.lucide.createIcons();const B=document.getElementById("clinicalOutcomeGraphCard");if(B){new IntersectionObserver(r=>{r.forEach(s=>{s.isIntersecting&&B.classList.add("is-drawn")})},{threshold:.2}).observe(B);const e=B.querySelectorAll(".chart-tab-btn"),o=document.getElementById("graphLinePath"),n=document.getElementById("graphAreaPath");e&&o&&n&&e.forEach(r=>{r.addEventListener("click",()=>{e.forEach(f=>f.classList.remove("active")),r.classList.add("active"),r.getAttribute("data-graph")==="recovery"?(o.setAttribute("d","M 30 160 Q 150 70, 250 80 T 470 20"),n.setAttribute("d","M 30 160 Q 150 70, 250 80 T 470 20 L 470 180 L 30 180 Z")):(o.setAttribute("d","M 30 140 Q 150 110, 250 50 T 470 30"),n.setAttribute("d","M 30 140 Q 150 110, 250 50 T 470 30 L 470 180 L 30 180 Z"))})})}const H=document.getElementById("header");let _=document.getElementById("backToTopBtn");_||(_=document.createElement("button"),_.id="backToTopBtn",_.className="back-to-top-btn",_.setAttribute("aria-label","Back to top"),_.innerHTML=`
    ...
    `,document.body.appendChild(_),_.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})}));let E=!1;window.addEventListener("scroll",()=>{E||(window.requestAnimationFrame(()=>{const t=window.scrollY;t>20?H?.classList.add("scrolled"):H?.classList.remove("scrolled"),t>300?_?.classList.add("is-visible"):_?.classList.remove("is-visible"),document.querySelectorAll("[data-parallax], .hero-doctor-cutout, .editorial-ot-hero").forEach(o=>{const n=parseFloat(o.getAttribute("data-parallax-speed")||"-0.08"),r=t*n,s=parseFloat(o.dataset.lastParallax||"9999");Math.abs(r-s)>.5&&(o.style.transform=`translateY(${r}px)`,o.dataset.lastParallax=r)}),E=!1}),E=!0)},{passive:!0});const I=document.getElementById("mobileToggle"),F=document.getElementById("navLinks");I&&F&&I.addEventListener("click",()=>{F.classList.toggle("mobile-open")});const U=document.getElementById("toast"),te=document.getElementById("toastMessage");function R(t){U&&te&&(te.textContent=t,U.classList.add("show"),setTimeout(()=>{U.classList.remove("show")},3500))}const T=document.getElementById("viewMoreSpecialties");T&&T.addEventListener("click",t=>{t.preventDefault(),t.stopPropagation();const e=document.querySelectorAll(".specialty-card.hidden-card");if(T.classList.contains("expanded")){e.forEach(s=>{s.classList.remove("show-card"),s.classList.remove("user-expanded")}),T.classList.remove("expanded");const n=T.querySelector("span");n&&(n.textContent="View More Specialties");const r=T.querySelector("[data-lucide]");r&&r.setAttribute("data-lucide","chevron-down")}else{e.forEach(s=>{s.classList.add("show-card"),s.classList.add("user-expanded")}),T.classList.add("expanded");const n=T.querySelector("span");n&&(n.textContent="Show Less Specialties");const r=T.querySelector("[data-lucide]");r&&r.setAttribute("data-lucide","chevron-up")}window.lucide&&window.lucide.createIcons()});const se=[{id:"doc-0",name:"Dr. G. N. Sanadi",category:"ortho",categoryLabel:"Orthopaedics",specialty:"Founder & Chief Orthopaedic Surgeon",experience:"25+ Years Exp.",imgSrc:"/images/dr-sanadi-founder.webp"},{id:"doc-1",name:"Dr. Shrinivas Odugoudar",category:"neuro",categoryLabel:"Neurosurgery",specialty:"Consultant Neurosurgeon",experience:"15+ Years Exp.",imgSrc:"/images/doctor-2.webp"},{id:"doc-2",name:"Dr. Shekar Malvi",category:"ortho",categoryLabel:"Orthopaedics",specialty:"Trauma & Joint Replacement Surgeon",experience:"14+ Years Exp.",imgSrc:"/images/doctor-3.webp"},{id:"doc-3",name:"Dr. Jayant Kulkarni",category:"anaesthesia",categoryLabel:"Anaesthesiology",specialty:"Consultant Anaesthesiologist",experience:"18+ Years Exp.",imgSrc:"/images/doctor-1.webp"},{id:"doc-4",name:"Dr. Shivakumar H",category:"anaesthesia",categoryLabel:"Anaesthesiology",specialty:"Consultant Anaesthesiologist",experience:"12+ Years Exp.",imgSrc:"/images/doctor-4.webp"},{id:"doc-5",name:"Dr. Santosh Gokak",category:"ortho",categoryLabel:"Orthopaedics",specialty:"In-charge Doctor & Physician",experience:"10+ Years Exp.",imgSrc:"/images/doctor-5.webp"}],W=document.getElementById("doctorGridTrack"),C=document.getElementById("doctorSliderTrack"),oe=document.getElementById("docSliderPrev"),re=document.getElementById("docSliderNext");function ce(){C&&(C.innerHTML="",se.forEach((t,e)=>{const o=document.createElement("div");o.className="specialist-card-item",o.style.animationDelay=`${e*.1}s`;const r=t.id==="doc-0"?`<img src="${t.imgSrc}" alt="${t.name}">`:`<div class="specialist-placeholder-bg">
        ...
        `,C.appendChild(o)})),W&&(W.innerHTML="",se.forEach((t,e)=>{const o=document.createElement("div");o.className="specialist-flip-card",o.style.animationDelay=`${e*.1}s`;const r=t.id==="doc-0"?`<img src="${t.imgSrc}" alt="${t.name}">`:`<div class="specialist-placeholder-bg">
              <div class="specialist-placeholder-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                  <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path>
                  <circle cx="12" cy="7" r="4"></circle>
        ...
        `,o.addEventListener("click",s=>{s.target.closest("a")||o.classList.toggle("is-flipped")}),W.appendChild(o)})),window.lucide&&window.lucide.createIcons(),C&&(C.scrollLeft=0)}function ie(){if(!C)return 340;const t=C.querySelector(".specialist-card-item");if(t){const e=t.offsetWidth,o=window.getComputedStyle(C),n=parseFloat(o.gap)||28;return e+n}return 340}oe&&C&&oe.addEventListener("click",()=>{C.scrollBy({left:-ie(),behavior:"smooth"})}),re&&C&&re.addEventListener("click",()=>{C.scrollBy({left:ie(),behavior:"smooth"})}),ce(),document.querySelectorAll(".specialty-card").forEach(t=>{t.addEventListener("mousemove",e=>{const o=t.getBoundingClientRect(),n=e.clientX-o.left-o.width/2,r=e.clientY-o.top-o.height/2,s=Math.atan2(r,n);t.style.setProperty("--rotation",`${s}rad`)}),t.addEventListener("mouseleave",()=>{t.style.setProperty("--rotation","0deg")})});const Q=document.querySelector(".facilities-grid");if(Q){const t=Q.querySelectorAll(".facility-card"),e=120;document.addEventListener("pointermove",o=>{const n=Q.getBoundingClientRect(),r=o.clientX,s=o.clientY,f=r>=n.left-e&&r<=n.right+e&&s>=n.top-e&&s<=n.bottom+e;t.forEach(i=>{if(!f){i.style.setProperty("--spotlight-opacity","0");return}const d=i.getBoundingClientRect();if(r>=d.left-e&&r<=d.right+e&&s>=d.top-e&&s<=d.bottom+e){const g=r-d.left,u=s-d.top;i.style.setProperty("--mouse-x",`${g}px`),i.style.setProperty("--mouse-y",`${u}px`),i.style.setProperty("--spotlight-opacity","1")}else i.style.setProperty("--spotlight-opacity","0")})},{passive:!0})}const ne=document.getElementById("contactForm"),K=document.getElementById("formSuccessMessage");ne&&ne.addEventListener("submit",t=>{t.preventDefault();const e=document.getElementById("fullName"),o=document.getElementById("phoneNum"),n=document.getElementById("emailAddr"),r=document.getElementById("preferredDate"),s=document.getElementById("specialtySelect"),f=document.getElementById("message"),i=e?.value.trim()||"",d=o?.value.trim()||"",p=n?.value.trim()||"N/A",g=r?.value||"N/A",u=s?.value||"",a=f?.value.trim()||"";if([e,o,s,f].forEach(m=>{m&&(m.style.borderColor="")}),!i){e&&(e.style.borderColor="#EF4444"),R("⚠️ Please enter your Full Name."),e?.focus();return}if(!d||d.length<7){o&&(o.style.borderColor="#EF4444"),R("⚠️ Please enter a valid Mobile Number."),o?.focus();return}if(!u){s&&(s.style.borderColor="#EF4444"),R("⚠️ Please select a Service / Specialty."),s?.focus();return}if(!a){f&&(f.style.borderColor="#EF4444"),R("⚠️ Please describe your Message / Requirements."),f?.focus();return}const l="917892869257";let c=`New Service Request
